...
class _EstimatedRequirementsCardState extends State<EstimatedRequirementsCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      Text('MSJ Calories: ${(provider.gender==Gender.male)?(provider.mifflinMale).toStringAsFixed(0):(provider.mifflinFemale).toStringAsFixed(0)}kcal\nProtein Range: ${provider.lowerProteinRange.toStringAsFixed(0)}-${provider.upperProteinRange.toStringAsFixed(0)} g\nFluid(60/60+): ${(provider.kg * 35).toStringAsFixed(0)}/${(provider.kg * 30).toStringAsFixed(0)}ml '),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text('-25% (BMI>30)'),
                            Checkbox(value: provider.minus25Percent, onChanged: (value) => provider.setMinus25Percent(),),
                            Text('-35% (BMI>50)'),
                            Checkbox(value: provider.minus35Percent, onChanged: (value) => provider.setMinus35Percent(),),
                          ],
                        ),
                      ],
                    ),
